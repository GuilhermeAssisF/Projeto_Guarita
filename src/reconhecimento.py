...
class DetectorPlaca:
    ...
    def processar(self, frame):
        ...
        Retorna: (frame_desenhado, texto_placa_ou_None, imagem_recortada_ou_None)
        """
        ...
        if location is not None:
            ...
            try:
                ...
                pass  # Ignora erros de recorte momentâneos
